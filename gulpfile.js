...
gulp.task('prettify', function(){
    gulp.src(['node_modules/bootstrap/dist/js/bootstrap.min.js','node_modules/mustache/mustache.min.js','node_modules/jquery/dist/jquery.min.js','app/js/popper.min.js','app/js/popper.min.js'])
        .pipe(prettify())
        .pipe(gulp.dest('app/js'));
});
